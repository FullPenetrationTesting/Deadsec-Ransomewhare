...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Label3.configure(text='''Author : deadsec   |  Website : https://deadsec.com   |  Github : github.com/FullPenetrationTesting/''')
        ...
        self.Label5.configure(text='''Software Made for Good Purpose for Community!!     illegal Use is Prohibited (joking)!!''')
